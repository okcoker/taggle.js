...
a.tags[j]+'" name="'+a.hiddenInputName+'"></li>',l.push(a.tags[j].toLowerCase());a.placeholder&&(g.text(a.placeholder),a.tags.length||g.fadeIn("fast"));v.appendChild(b);m.appendChild(v);d.append(m);d.on("click",function(){b.focus()});b.onfocus=s;b.onblur=function(){b.value="";n();d.hasClass(a.containerFocusClass)&&d.removeClass(a.containerFocusClass);!l.length&&a.placeholder&&g.fadeIn("fast")};b.addEventListener?(b.addEventListener("keydown",t,!1),b.addEventListener("keyup",u,!1)):b.attachEvent&&
(b.attachEvent("onkeydown",t),b.attachEvent("onkeyup",u));d.find(".close").one("click",q)})}})(jQuery);